...
public class Elev {
    ...
    public Elev(int elevId,String nume, String prenume, String dataNasterii, boolean repetent, boolean corigent, int nr_absente_nemotivate, float medieGenerala){
        this.elevId = elevId;
        this.nume = nume;
    ...
    public void setElevId(int elevId) {
        this.elevId = elevId;
    }
